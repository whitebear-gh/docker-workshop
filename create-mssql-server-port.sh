...
docker run -e 'ACCEPT_EULA=Y' -e 'SA_PASSWORD=vDbi2DiPmRFghIoC8B' --name=docker-workshop-mssql -p 1433:1433  -d microsoft/mssql-server-linux:2017-latest >> /dev/null
echo "Done."
